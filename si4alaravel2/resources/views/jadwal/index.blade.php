            ...
            <table class="table" >
                ...
                @foreach ($jadwal as $item)
                    <tr>
                        ...
                        <td>
                         <a href="{{ route('jadwal.show', $item->id) }}" class="btn btn-primary">Show</a>
                            ...
                            <form action="{{ route('jadwal.destroy', $item->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger show_confirm" data-lte-toggle="tooltip" title="Delete" data-nama="{{$item->id}}">Delete</button>
                                </form>
                                </td>
                    </tr>
                @endforeach
